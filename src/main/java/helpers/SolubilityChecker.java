...
//
//    public static boolean isSolvable(final State puzzle) {
//        int puzzleDimension = puzzle.getDimension();
...
//    }
//
////    private static int[] transformMatrixIntoVector(final State puzzle, int puzzleDimension) {
